				...
				<div className='modal-back'>
					<div className='mini-modal'>
						...
						<div className='fluent_form'>
							<input type="text" placeholder="Nom de votre dossier" autoFocus onChange={(e) => setNewDirectory(e.target.value)} />
						</div>
						...
						<div className='footer'>
							...
							<div className="small_fluent_btn blue" style={{ width: 100 }} onClick={() => props.newDirectory(props.path, new_directory)}>
					...
					<div className='modal-back'>
						<div className='small-modal'>
							...
							<div className='footer'>
								...
								<div className="small_fluent_btn red" style={{ width: 130 }} onClick={() => props.remove(props.path, new_directory)}>
